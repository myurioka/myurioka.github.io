...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width,initial-scale=1"},{"charset":"utf-16"}],"link":[],"style":[],"script":[],"noscript":[],"charset":"utf-16","viewport":"width=device-width,initial-scale=1","title":"Programing Retro Game in Rust & Wasm","titleTemplate":"%s - Programing Retro Game in Rust & Wasm"};
