...
import { a as useContentDisabled, u as useAsyncData, q as queryContent, w as withContentBase, e as encodeQueryParams, b as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-DiXo6x2D.mjs';
import { u as useContentPreview } from './preview-DaooDkFR.mjs';
import { d as useState, c as useRuntimeConfig } from './server.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-B79I17hf.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-BRmLSKmh.mjs.map
