...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./entry-styles.BpdbnZ6N.mjs').then(interopDefault),
  ...
  "components/category/card.vue": () => import('./card-styles.kPqp7Re7.mjs').then(interopDefault),
