...
const _routes = [
  ...
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-CFZnjRq8.mjs')
  }
];
...
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-DXdfCU8r.mjs').then((r) => r["default"] || r.default || r));
...
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-oF9kOSRE.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-DGQlqgwI.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-D8uHdm7X.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-CaeUyDKE.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-Dw9GtFP2.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-NsmVZdQs.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-CRaLZRAN.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-DCQWvJOF.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-B7tpscti.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-Bidow6pB.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-7s17pckO.mjs').then((r) => r["default"] || r.default || r));
...
const LazyIcon = defineAsyncComponent(() => import('./Icon-MaE-4ymI.mjs').then((r) => r["default"] || r.default || r));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-q7BHfkiy.mjs').then((r) => r["default"] || r.default || r));
