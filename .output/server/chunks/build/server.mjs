import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, toRef, isRef, defineAsyncComponent, defineComponent, h, computed, unref, provide, shallowReactive, Suspense, nextTick, Fragment, Transition, mergeProps, createApp, effectScope, reactive, getCurrentScope, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, useSSRContext, withCtx, shallowRef, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { $ as $fetch, m as hasProtocol, n as isScriptProtocol, o as joinURL, w as withQuery, h as createError$1, p as defu, q as sanitizeStatusCode, r as createHooks, t as toRouteMatcher, v as createRouter$1 } from '../runtime.mjs';
...
const _routes = [
  ...
  },
  {
    name: "slug",
    path: "/:slug()",
    component: () => import('./_slug_-C2rePFEZ.mjs')
  },
  {
    name: "about",
    path: "/about",
    component: () => import('./about-LL8Ef2rF.mjs')
  },
  {
    name: "blogs-blog",
    path: "/blogs/:blog()",
    component: () => import('./_blog_-DD24T46d.mjs')
  },
  {
    name: "blogs",
    path: "/blogs",
    component: () => import('./index-BNqtTPqC.mjs')
  },
  {
  ...
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BRcMwQyE.mjs')
  }
];
...
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-pq0CmGjl.mjs').then((r) => r["default"] || r.default || r));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-BDGT4n33.mjs').then((r) => r["default"] || r.default || r));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-BRmLSKmh.mjs').then((r) => r["default"] || r.default || r));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-DBY8knRz.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-DEVps2uo.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-H77DBzko.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-B4t_zVkW.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-BbyG0TiW.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2--VqJ1_ys.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-BkeynZ_c.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-B4w2BsJF.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5--rUjonZC.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-C7NqhzYY.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-Bidow6pB.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-BxbtVhFJ.mjs').then((r) => r["default"] || r.default || r));
...
const LazyIcon = defineAsyncComponent(() => import('./Icon-H3opb0lx.mjs').then((r) => r["default"] || r.default || r));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-BBGsqbAK.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: () => import('./default-Zl6CXkM6.mjs')
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-VLyenYWh.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Bd60DDh3.mjs'));
...
export { useRoute as a, useRequestEvent as b, useRuntimeConfig as c, useState as d, entry$1 as default, useNuxtApp as e, asyncDataDefaults as f, createError as g, useRouter as h, nuxtLinkDefaults as i, navigateTo as n, resolveRouteObject as r, useHead as u };
