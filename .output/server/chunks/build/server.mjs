import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, toRef, isRef, defineAsyncComponent, defineComponent, createElementBlock, unref, useSSRContext, createApp, effectScope, shallowReactive, reactive, getCurrentScope, mergeProps, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { $ as $fetch, m as hasProtocol, n as isScriptProtocol, o as joinURL, w as withQuery, h as createError$1, p as sanitizeStatusCode, q as createHooks, t as toRouteMatcher, r as createRouter$1, v as defu } from '../runtime.mjs';
...
const _routes = [
  {
    name: "slug",
    path: "/:slug()",
    component: () => import('./_slug_-ApvjeGR-.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DQ0Txc_a.mjs')
  }
];
...
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-D0kn-0W_.mjs').then((r) => r["default"] || r.default || r));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-DQRx4uVj.mjs').then((r) => r["default"] || r.default || r));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-BM0Rv_Vh.mjs').then((r) => r["default"] || r.default || r));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-DVff7gX2.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-BOzz231f.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-CU6Mh0UG.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseCodeInline = defineAsyncComponent(() => import('./ProseCodeInline-BSWlN4c4.mjs').then((r) => r["default"] || r.default || r));
const LazyProsePre = defineAsyncComponent(() => import('./ProsePre-B0teryc4.mjs').then((r) => r["default"] || r.default || r));
const LazyProseA = defineAsyncComponent(() => import('./ProseA-D7s7BXzK.mjs').then((r) => r["default"] || r.default || r));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-DYJ_1fCO.mjs').then((r) => r["default"] || r.default || r));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-kjPm_8pM.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-C9N-4dOq.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-C5rEVq3r.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-Cr1hKkDQ.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-BLCjjAXa.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-CFE_UlQS.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-DtxRejjK.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-CuEABlUe.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-CFbmeVTd.mjs').then((r) => r["default"] || r.default || r));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-BXUH4508.mjs').then((r) => r["default"] || r.default || r));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-C6IKIBrW.mjs').then((r) => r["default"] || r.default || r));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-CKbVbgL1.mjs').then((r) => r["default"] || r.default || r));
const LazyProseScript = defineAsyncComponent(() => import('./ProseScript-D0R07iM6.mjs').then((r) => r["default"] || r.default || r));
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-B8ce86Tf.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-D02AuSbB.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-Csjkzwzw.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-D0ZvMrPm.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-DOYiBfDP.mjs').then((r) => r["default"] || r.default || r));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-BiuSMsuo.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-DO13LtQB.mjs').then((r) => r["default"] || r.default || r));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-hxiaPkx4.mjs').then((r) => r["default"] || r.default || r));
const LazyIcon = defineAsyncComponent(() => import('./Icon-DBODd76F.mjs').then((r) => r["default"] || r.default || r));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-BHWk53sB.mjs').then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CHwcziWB.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DRdrDxDP.mjs'));
...
export { _export_sfc as _, useRoute as a, useRuntimeConfig as b, useState as c, useNuxtApp as d, entry$1 as default, asyncDataDefaults as e, createError as f, useRequestEvent as g, useRouter as h, navigateTo as i, nuxtLinkDefaults as n, resolveRouteObject as r, useHead as u };
