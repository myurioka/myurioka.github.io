...
import { e as useNuxtApp, f as asyncDataDefaults, g as createError, c as useRuntimeConfig, b as useRequestEvent } from './server.mjs';
import { A as withLeadingSlash, o as joinURL, y as withoutTrailingSlash, B as withBase, z as hash } from '../runtime.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-B79I17hf.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-DiXo6x2D.mjs.map
