...
import { h as homePage } from './index-ZsnywngQ.mjs';
import __nuxt_component_1 from './Icon-MaE-4ymI.mjs';
import { _ as _sfc_main$2$1, a as __nuxt_component_1$1, b as __nuxt_component_4 } from './empty-ClVKHd6R.mjs';
  ...
  async setup(__props) {
    ...
    useHead({
      ...
      meta: [
        {
          name: "description",
          content: "Welcome To My Blog. Programming Retro Mini Game in Rust & WebAssembly."
        }
      ]
    });
    return (_ctx, _push, _parent, _attrs) => {
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<article${ssrRenderAttrs(mergeProps({ class: "group border dark:border-gray-800 m-2 overflow-hidden shadow-sm text-zinc-700 dark:text-zinc-300" }, _attrs))}>`);
...
//# sourceMappingURL=index-D2fdfHHZ.mjs.map
